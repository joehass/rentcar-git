            ...
            <div class="row">
                <div class="navbar-collapse collapse" >
                    <ul class="nav navbar-nav" style="border: 1px solid #ccc;border-radius:15px;">
                        ...
                        <li class="active"><a style="font-family: 仿宋;color:red;font-size: 2em;" href="#">还车</a></li>
                    	...
                    	<li><a style="font-family: 仿宋;color:black;font-size: 2em;" href="<%=request.getContextPath()%>/order/baoxiu2?u_card=${user.u_card}">汽车报修</a></li>
	                             ...
	                             <div id="order_review" style="position: relative;">
	                                 <table class="shop_table" style="position: relative;width: 550px;">
	                                     <tfoot>
	                                         <tr class="shipping">
	                                             <th>订单号</th>
	                                             <td><span id="o_code">${o_code }</span></td>
	                                         </tr>
	                                         <tr class="shipping">
	                                             <th>身份证号</th>
	                                             <td>${user.u_card}</td>
...
function scdd(){
	...
	if(b){
		...
		$.post("${pageContext.request.contextPath}/order/returnCar1?orderList="+orderList,function(data){
			if("success"==data.status){
				debugger;
				alert("还车成功");
				window.location.href='${pageContext.request.contextPath}/order/getOrders?u_card=${user.u_card}';
			}
		});
	}else{
	}
