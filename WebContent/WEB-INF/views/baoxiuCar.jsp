            ...
            <div class="row">
                <div class="navbar-collapse collapse" >
                     <ul class="nav navbar-nav" style="border: 1px solid #ccc;border-radius:15px;">
                        ...
                        <li><a style="font-family: 仿宋;color:black;font-size: 2em;" href="#">汽车详情</a></li>
...
function scdd(){
	...
	if(b){
		...
		$.post("${pageContext.request.contextPath}/order/baoxiu1?orderList="+orderList,function(data){
			if("1"==data){
				debugger;
				alert("报修成功");
